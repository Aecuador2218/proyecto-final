...
class PatientListView(ListView,ListViewMixin):
...
class PatientCreateView(CreateView,CreateViewMixin) :
    model = Paciente
...
class PatientUpdateView(UpdateView,UpdateViewMixin):
    model = Paciente
    template_name = 'core/patient/form.html'
    form_class = PatientForm
    success_url = reverse_lazy('core:patient_list')
...
class PatientDeleteView(DeleteView,DeleteViewMixin):
    model = Paciente
    # template_name = 'core/patient/form.html'
    success_url = reverse_lazy('core:patient_list')
